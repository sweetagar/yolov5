...
CUDA_VISIBLE_DEVICES=0 python transform.py --model_file ../runs/train/baby-head-4bit/weights/best.onnx --output_file ./venus_sample_yolov5s/yolov5s_t41_magik.mk.h --config_file cfg/magik_t41.cfg
